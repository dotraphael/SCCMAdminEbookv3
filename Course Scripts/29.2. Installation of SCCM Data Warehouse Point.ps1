...
Add-CMDataWarehouseServicePoint -SiteSystemServerName "$ServerName" -DataWarehouseDatabaseName "CM_$($SiteCode)_DW" -DataWarehouseDatabaseServerName "$ServerName" -DataWarehouseSqlPort 1433 -SiteCode "$SiteCode" -WeekFrequency 1
