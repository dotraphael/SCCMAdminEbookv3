...
Add-CMDeviceCollectionQueryMembershipRule -CollectionId $Collection.CollectionID -RuleName "Windows 8"  -QueryExpression "select * from SMS_R_System where OperatingSystemNameandVersion like '%Windows NT Workstation 6.3%'"
start-sleep 20
