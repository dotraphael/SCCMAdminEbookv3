...
Add-CMReportingServicePoint -ReportServerInstance "MSSQLSERVER" -SiteSystemServerName "$servername" -UserName "$account" -DatabaseName "CM_$SiteCode" -DatabaseServerName "$servername" -FolderName "ConfigMgr_$SiteCode" -SiteCode "$SiteCode"  
