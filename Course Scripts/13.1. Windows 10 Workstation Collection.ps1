...
Add-CMDeviceCollectionQueryMembershipRule -CollectionId $Collection.CollectionID -RuleName "Windows 10"  -QueryExpression "select * from SMS_R_System where OperatingSystemNameandVersion like '%Windows NT Workstation 10%'"
start-sleep 20
