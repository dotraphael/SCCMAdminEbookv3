...
Add-CMApplicationCatalogWebsitePoint -ApplicationWebServicePointServerName "$servername" -CommunicationType HTTP -SiteSystemServerName "$servername" -NetBiosName $servernameNetbios -OrganizationName "Training Lab" -Port 80 -SiteCode $SiteCode
